...
import 'package:semtepo/selecionar_tarefas_screen.dart';
...
class _AgendarTarefaScreenState extends State<AgendarTarefaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Agenda para marcar tarefa'),
                ...
                onPressed: _selectedTime != null
                    ? () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SelecionarPacienteTarefaScreen(
                              date: _selectedDate,
                              time: _selectedTime!,
                            ),
                          ),
...
// Classes placeholders para que o código seja executável
...
class MeuPerfilScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text('Meu Perfil')));
  }
}
